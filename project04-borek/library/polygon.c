...
const double CROSS_CONST = .5;
const int SUM_ELEM_AREA = 6;
...
double polygon_area(list_t *polygon){
  ...
  double area = CROSS_CONST * (cross1);
  return area;
}
...
vector_t polygon_centroid(list_t *polygon){
  ...
  sum_elem_x = (1/ (SUM_ELEM_AREA * area)) * sum_elem_x; // x component of center
  sum_elem_y = (1/ (SUM_ELEM_AREA * area)) * sum_elem_y; // y component of center
