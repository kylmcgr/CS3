...
void body_set_texture(body_t *body, void* texture){
  body->texture = texture;
}

void* body_get_texture(body_t *body){
  return body->texture;
}

void body_set_aux(body_t *body, int aux){
  body->aux = aux;
}

int body_get_aux(body_t *body){
  return body->aux;
}

void body_set_text(body_t *body, void* text){
  body->text = text;
}

void* body_get_text(body_t *body){
  return body->text;
}
